...
- **Cloud**: AWS (EC2, S3, биллинг), Google Cloud (Compute Engine, биллинг), Oracle Cloud
- **Виртуализация и бэкапы**: Proxmox VE, Proxmox Backup Server, rclone, ZFS RAID, Garage S3, AWS S3, Backblaze B2
...
- **Network Engineering**: WireGuard, AmneziaWG, Xray, VLESS, REALITY, Hysteria2, SOCKS5, WebSocket-проксирование, Mikrotik RouterOS, администрирование OpenWrt, VLAN-сегментация (Proxmox), настройка файрволов на роутерах
...
- **AI/LLM**: динамический роутинг моделей (свап по задаче и по исчерпанию токенов), настройка AI-агентов через MCP, настройка RAG (Paperless-ngx)
